...
*/
			...
			render()
			difference(){
				translate([-block_bevel_r-shift,0,0])
				cube([block_bevel_r*2+wade_block_width,
					base_thickness+block_bevel_r,wade_block_depth]);				
				translate([-block_bevel_r-shift,block_bevel_r+base_thickness])
				cylinder(r=block_bevel_r,h=wade_block_depth,$fn=60);
				translate([wade_block_width+block_bevel_r-shift,
...
//			translate([-filament_feed_hole_offset-4,-10,wade_block_depth/2])
//			rotate([90,0,0])
//			#cube(30,4);	
