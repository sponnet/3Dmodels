...
module bearing_base(){
	h=7;
	hull_w = 15;
	beltclamp_l=21-5; // height of belt clamp
	beltclamp_r=21-9; // height of belt clamp
	...
	difference(){
		union(){
			...
			// belt clamps				
			translate([11.5-5,27,0]) beltclamp(beltclamp_r);
			translate([-11.5-25,27,0]) beltclamp(beltclamp_l);
			...
			translate([6,0,0]){
				translate([-25,-23,0]){
					difference(){
						hull(){
							translate([0,0,7+7])rotate([90,0,0])cylinder(h=4,r=8/2);
							translate([0,0,7])rotate([90,0,0])cylinder(h=4,r=8/2);	
						}
		...
		translate([11.5-5,27,0]) beltclamp_neg(beltclamp_r);
		translate([-11.5-25,27,0]) beltclamp_neg(beltclamp_l);		
		
	}
}

module beltclamp(h){
		cube([30,13,h],center=false);
}

module beltclamp_neg(h){
		translate([10/2,2,-1]) #cube([4,2,h+2],center=false);
		translate([10/2+5*2,2,-1]) #cube([4,2,h+2],center=false);		
		translate([10/2+5*3+2.5,2,-1]) #cube([4,2,h+2],center=false);		

		translate([10/2,2+7,-1]) #cube([4,2,h+2],center=false);	
		translate([10/2+5*2,2+7,-1]) #cube([4,2,h+2],center=false);		
		translate([10/2+5*3+2.5,2+7,-1]) #cube([4,2,h+2],center=false);		
